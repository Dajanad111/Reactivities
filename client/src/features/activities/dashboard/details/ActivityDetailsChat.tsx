...
const ActivityDetailsChat= observer (function ActivityDetailsChat() {
    ...
    const {commentStore}= useComments(id);
     ...
     const handleKeyPress = (event: React.KeyboardEvent<HTMLDivElement>) => { //postavljanje komentgara na enter i prelazenje u novi red sa shift
            ...
            <Card>
                <CardContent>
                    <div>
                        <form>
                            <TextField
                            {...register('body', {required: true})} //da ne mozes da submitujes prazan kom 
                                variant="outlined"
                                fullWidth
                                multiline
                                rows={2}
                                placeholder="Enter your comment (Enter to submit, SHIFT + Enter for new line)"
                                onKeyDown={handleKeyPress}  //metoda koju smo napravili
                                slotProps={{
                                    input: {
