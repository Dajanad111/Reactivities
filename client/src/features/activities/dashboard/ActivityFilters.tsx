...
const ActivityFilters =observer( function ActivityFilters() {   //moramo je napraviti observer da bi mobx radio, tj cuvanje filtera
    ...
    return (
        <Box sx={{display: 'flex', flexDirection: 'column', gap: 3, borderRadius: 3}}>
            <Paper sx={{p:3, borderRadius: 3}}>
                <Box sx={{ width: '100%'}}>
                    ...
                    <MenuList>
                        ...
                        <MenuItem
                            selected={filter === 'isGoing'} //filter iz getactivitylist
            ...
            <Box component={Paper} sx={{ width: '100%', p: 3, borderRadius: 3 }}>
                ...
                <Calendar 
                 value={startDate} //danasnji datum obiljezen u kalendar
