import { Button, Alert, ButtonGroup, Typography } from '@mui/material';
import { useMutation } from '@tanstack/react-query';
import {useState} from "react";
import agent from '../../../../lib/api/agent.ts';

export default function TestErrors() { 
    const [validationErrors, setValidationErrors] = useState<string[]>([]); //  Stanje za čuvanje validacionih grešaka
    
    const { mutate } = useMutation({ 
    //  useMutation = "funkcija za POST/PUT/DELETE zahteve"
